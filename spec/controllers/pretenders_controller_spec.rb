...
describe PretendersController do
  ...
  describe "GET new" do
    it "assigns a new pretender as @pretender" do
      get :new, {}, valid_session
      assigns(:pretender).should be_a_new(Pretender)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pretender as @pretender" do
        # Trigger the behavior that occurs when invalid params are submitted
        Pretender.any_instance.stub(:save).and_return(false)
        post :create, {:pretender => {}}, valid_session
        assigns(:pretender).should be_a_new(Pretender)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pretender" do
        ...
        Pretender.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => pretender.to_param, :pretender => {'these' => 'params'}}, valid_session
      end
